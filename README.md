...
%%{init: {
  ...
  "themeVariables": {
    ...
    "secondaryTextColor": "#20261f",
    "tertiaryTextColor": "#20261f",
    "lineColor": "#7a8076",
    "clusterBkg": "#f7f4ea",
  ...
  "flowchart": { "nodeSpacing": 55, "rankSpacing": 65, "curve": "basis" }
}}%%
flowchart TD
    ...
    subgraph PRE[PHASE 0 · Deal-making · Aug–Dec 2026]
    ...
    subgraph FARM[PHASE 1 · Grower side · 2027 crop year]
    ...
    subgraph V[PHASE 2 · Viserion Lake Providence elevator]
